  ...
  return (
    <div className="flex flex-col justify-center items-center py-20 bg-gray-100">
      <h1 className="lg:text-3xl text-2xl font-title font-bold text-center tracking-wider uppercase text-gray-900 mb-16">
        New to Trendy <span className="text-blue-700">Boutique</span>? Register Here!
      </h1>
      <div className="w-full max-w-md p-8 space-y-8 bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          {/* Name Field */}
          <div>
            <Label htmlFor="name" className="block mb-4 tracking-wider font-para">
              Your Name
            </Label>
            <TextInput
              id="name"
            ...
            />
            {errors.name && <Alert color="failure">{errors.name.message}</Alert>}
          </div>

          {/* Email Field */}
          <div>
            <Label htmlFor="email" className="block mb-4 tracking-wider font-para">
              Your Email
            </Label>
            <TextInput
              id="email"
          ...
          {/* Password Field */}
          <div>
            <Label htmlFor="password" className="block mb-4 tracking-wider font-para">
              Your Password
            </Label>
            <TextInput
              id="password"
          ...
          <div>
            <Label htmlFor="confirmPassword" className="block mb-4 tracking-wider font-para">
              Confirm Password
            </Label>
            <TextInput
              id="confirmPassword"
            ...
            />
            {errors.confirmPassword && <Alert color="failure">{errors.confirmPassword.message}</Alert>}
          </div>

          {/* Photo URL Field */}
          <div>
            <Label htmlFor="photoURL" className="block mb-4 tracking-wider font-para">
              Profile Photo URL
            </Label>
            <TextInput
              id="photoURL"
            ...
            />
            {errors.photoURL && <Alert color="failure">{errors.photoURL.message}</Alert>}
          </div>
          ...
          {errors.terms && <Alert color="failure">{errors.terms.message}</Alert>}
