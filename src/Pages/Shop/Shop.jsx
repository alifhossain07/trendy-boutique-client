...
import Swal from "sweetalert2"; // Ensure to import SweetAlert
            ...
            {selectedProduct && (
                <Modal dismissible show={openModal} onClose={closeModal}>
                    ...
                    <Modal.Footer>
                        ...
                        <Button className="bg-orange-500 hover:!bg-orange-300 font-para" onClick={() => { addToWishlist(selectedProduct); closeModal(); }}>
                            Add to Wishlist
                        </Button>
